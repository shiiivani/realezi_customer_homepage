...
const bottomText = document.getElementById("section-bottom-text");
const bottomCont = document.querySelector(".section-one-bottom-outer");
const buttonLink = document.querySelector(".section-one-bottom button a");
...
const slideLinks = [
  "/",
  "https://www.realezi.com/architecture",
  "https://www.realezi.com/interior",
  "https://www.realezi.com/homeloan",
  "https://www.realezi.com/Legal-Aid-Realezi",
  "https://www.realezi.com/solar-panel",
  "https://www.realezi.com/movers-and-packers",
];
...
function updateBottomText(index) {
  bottomText.innerHTML = slideTexts[index];
  buttonLink.href = slideLinks[index];
