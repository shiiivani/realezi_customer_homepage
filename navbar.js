...
// Resources Dropdown
const resourceContainerItem = document.querySelector(".resource-container li");
const resourceMainDropdown = document.querySelector(".resource-main-dropdown");
